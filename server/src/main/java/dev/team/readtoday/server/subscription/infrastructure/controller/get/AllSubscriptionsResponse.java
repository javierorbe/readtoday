...
public class AllSubscriptionsResponse {
    ...
    public AllSubscriptionsResponse(Collection<Channel> subscriptionList, Collection<Category> categoryList){
    ...
    public List<ChannelResponse> getSubscriptionList(){ return subscriptionList;}
    public List<CategoryResponse> getCategoryList(){ return categoryList;}
}
